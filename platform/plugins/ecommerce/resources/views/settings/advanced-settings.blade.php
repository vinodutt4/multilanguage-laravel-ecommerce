        ...
        {!! Form::open(['url' => route('ecommerce.advanced-settings'), 'class' => 'main-setting-form']) !!}
            ...
            >
                ...
                <x-core-setting::on-off
                    ...
                    :value="EcommerceHelper::isPhoneFieldOptionalAtCheckout()"
                />
                ...
                <div @class(['recently-viewed-products-settings-container mb-4 border rounded-top rounded-bottom p-3 bg-light', 'd-none' => !EcommerceHelper::isEnabledCustomerRecentlyViewedProducts()])>
                    <x-core-setting::text-input
